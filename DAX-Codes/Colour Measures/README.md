...
With the code below you can create them in bulk in the DAX Query View. 

You just need to amend them to your colour needs. 

A piece of advice: always keep a transparent colour in your model as it can come handy.
